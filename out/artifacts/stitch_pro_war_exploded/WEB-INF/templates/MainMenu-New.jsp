...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath}/static/css/mainmenu-New.css">
</head>
<body>
<%--导航--%>
<header>
    <nav class="navbar" role="navigation" aria-label="main navigation">
            ...
            <a class="navbar-item" href="#">
                <svg width="640" height="160" viewBox="0 0 640 160" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd"
                          ...
                          fill="black" class="bd-svg-black"></path>
                    <path fill-rule="evenodd" clip-rule="evenodd"
        ...
        <div id="navbarBasicExample" class="navbar-menu">
            <div class="navbar-start">
                <a class="navbar-item page-click">
                    首页
                </a>
                ...
                <div class="navbar-item has-dropdown is-hoverable">
                    ...
                    <div class="navbar-dropdown is-boxed">
                        <a class="navbar-item page-click" data-page="ShikigmainDisplay/shikigamis">
                            式神录
                        </a>
                        <a class="navbar-item page-click">
                            测试后
            ...
            <div class="navbar-end">
                <div class="navbar-item">
                    <div class="buttons">
                        <a class="button is-primary page-click">
                            <strong>注册</strong>
                        </a>
                        <a class="button is-light page-click">
                            登陆
                        </a>
                    </div>
                </div>
...
<iframe id="jspContent">

</iframe>
</body>
<script type="module" src="${pageContext.request.contextPath}/static/js/mainmenu-New.js"></script>
</html>
